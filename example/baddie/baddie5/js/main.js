...
*/
     ...
     * @param {Float} relativeSize - floating point number to specify
     *                                  relative size (half of window: 0.5)
     */
    ...
    /////////////////////////////////////////////////////////////
    // CREATE SOME FUNCTIONS TO FILL MODAL BASED ON            //
    // A: WHAT WAS CLICKED AND B: WHAT STATE THAT LOCATION HAS //
    /////////////////////////////////////////////////////////////
        ...
        input.addEventListener("keydown", function (event) {
            ...
            if (key == 13) {
                ...
                if (condition) {
                    ...
                    // Print out if the guess was higher or lower than the number -
                    //      either first or last in textarea
                }
            }

            // Since there is another event listener for keydown on the
            //        whole window stopPropagation is needed
